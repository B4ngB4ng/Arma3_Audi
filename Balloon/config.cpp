...
class CfgVehicles
{
	...
	class Balloon: Helicopter_Base_H
	{
		...
		{
			class CopilotTurret: CopilotTurret						/// taking controls is already defined in parrent class
			{
				...
				minTurn = -170;  									/// what is the left-most possible turn of the turret
				maxTurn = 170;  									/// what is the right-most possible turn of the turret
				initTurn = 0; 										/// what is the default horizontal turn of the turret
				gunnerLeftHandAnimName = "lever_copilot";			/// what bone in model is the left hand connected to via IK (pilot has it set by default in parrent class)
				gunnerRightHandAnimName = "stick_copilot";			/// what bone in model is the right hand connected to via IK (pilot has it set by default in parrent class)
