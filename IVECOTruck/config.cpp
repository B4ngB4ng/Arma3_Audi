...
class CfgVehicles
{
	...
	class IVECOTruck: Car_F
	{
		model 	= "\Arma3_Audi\IVECOTruck\IVECOTruck";  /// simple path to model
	...
	class IVECOTruckCIV: IVECOTruck /// some class that is going to be visible in editor
	{	
